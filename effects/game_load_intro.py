...
class LoadIntro(pygame.sprite.Sprite):
    def __init__(self, title, x, y, radius):
        ...
        self.sprite_image = pygame.image.load("./local_assets/assets/source/Legacy Collection/Assets/Misc/spaceship-unit/Spritesheets/Spritesheet_thrust_updated.png").convert_alpha()
