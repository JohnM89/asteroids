...
class Thrust(pygame.sprite.Sprite):
    def __init__(self, player, contact_point, rotation):
        ...
        self.base_image = pygame.image.load('./assets/source/Super Pixel Projectiles Pack 2/spritesheet/pj2_fireball_large_yellow/spritesheet.png').convert_alpha()
        self.radius = 32
    ...
    def update(self, dt):
        ...
        self.sprite_image = pygame.transform.rotate(sub_surf, angle_degrees - 60)
