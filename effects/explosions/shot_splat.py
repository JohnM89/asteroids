...
class ShotSplat(pygame.sprite.Sprite):
    def __init__(self, contact_point, rotation, assets):
        ...
        # for img in os.listdir('./assets/sprites/ShotImpactSplat/'):
        #     self.explosions.append(pygame.image.load(os.path.join('./assets/sprites/ShotImpactSplat/', img)))
        # for img in os.listdir('./local_assets/assets/sprites/ShotImpactSplat/'):
        #     self.explosions.append(pygame.image.load(os.path.join('./local_assets/assets/sprites/ShotImpactSplat/', img)))

        # NEW: Use AssetManager
        self.explosions = self.assets.images_in('sprites/ShotImpactSplat')
        self.radius = 24
