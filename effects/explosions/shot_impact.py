...
class ShotImpact(pygame.sprite.Sprite):
    def __init__(self, contact_point, rotation, assets):
        ...
        #     self.explosions.append(pygame.image.load(os.path.join('./assets/sprites/ShotImpact/', img)))
        # for img in os.listdir('./local_assets/assets/sprites/ShotImpact/'):
        #     self.explosions.append(pygame.image.load(os.path.join('./local_assets/assets/sprites/ShotImpact/', img)))

        # NEW: Use AssetManager
        self.explosions = self.assets.images_in('sprites/ShotImpact')
        self.radius = 48
