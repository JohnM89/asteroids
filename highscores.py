        ...
        try:
            if os.path.isfile("./high_score.txt"):
                ...
                for line in lines:
                    if count <= 10:
                        score = line.strip()
                        new_score = UserInterface(self.score_box.x, self.score_box.y + (32 * count), 500, 32, "GravityRegular5", "Fonts/GravityRegular5.ttf", score )
                ...
                no_score = UserInterface(self.score_box.x, self.score_box.y + (32 * 5), 400, 64, "GravityRegular5", "Fonts/GravityRegular5.ttf", "No High Score yet bud")
